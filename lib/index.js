...
exports.randomAfter = exports.randomBefore = exports.random = exports.keySequence = exports.sequence = exports.delayFun = exports.delayAfter = exports.delayBefore = exports.delay = exports.repeat = void 0;
            ...
            switch (_a.label) {
                ...
                case 2:
                    if (times === 0)
                        ...
                        return [2 /*return*/, repeat(promiseFun, times, onError)];
                    else
                        return [2 /*return*/, repeat(promiseFun, times - 1, onError)];
                    return [2 /*return*/];
            }
        });
    }); });
